...
const Tooltip = styled(WrapperTooltip) `
  &:hover svg {
    opacity: 1;
    transform: scale(1.6);
  }
  ...
  svg {
    ...
    transition: transform 300ms ${p => p.theme.elastic2}, opacity 300ms ${p => p.theme.elastic2};
  }

  .message {
    position: absolute;
    top: ${p => (p.disabled ? '60px' : '150%')};
    left: 50%;
    line-height: 0.8em;
    margin: 0 5%;
...
class SocialLinks extends Component {
  ...
  render() {
    ...
    const items = [
      ...
      {
        key: 'pretty much amazing',
        data: (
          <Tooltip message="pretty much amazing" disabled={isTouchDevice}>
            <A href="./assets/app/dorian_ratovo_portfolio_2016_screen.pdf">
              <svg width="20" height="20" viewBox="0 0 20 20">
