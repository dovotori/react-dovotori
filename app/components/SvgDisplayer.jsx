    ...
    return (
      <svg style={{ display: 'none' }}>
        ...
        <symbol width="38" height="38" version="1.1" viewBox="0 0 10 10.2" id="logo3">
          <path
            fill="currentColor"
            d="m4.1 0-0.4 0.4 0.86 0.86-1.8 1.8 0.93 0.86v-0.93l0.4-0.4 0.46 0.46h0.79l0.46-0.46 0.4 0.4v0.93l0.93-0.86-1.8-1.8 0.86-0.86-0.4-0.4-0.86 0.86z"
          />
        ...
        <symbol width="25" height="25" viewBox="0 0 7.4 6.6" id="logo2">
          <path
            fill="currentColor"
            d="m4.5 2.4 0.53-0.53-1.1-1.1 0.53-0.53l-0.26-0.26-0.53 0.53-0.53-0.53-0.26 0.26 0.53 0.53-1.1 1.1 0.53 0.53v-0.53l0.26-0.26 0.26 0.26h0.53l0.26-0.26 0.26 0.26z"
          />
        ...
        <symbol width="68.5" height="25.5" viewBox="0 0 18.1 6.7" id="signature">
          ...
          <path
            fill="currentColor"
            d="m6.615 3.44v2.117h-2.381c-.5292 0-.5292-.5292-.5292-.5292v-1.323s0-.5292.5292-.5292h2.117c.2646 0 .2646.2646.2646.2646zm-2.381.2646v1.323h1.588c.2646 0 .2646-.2646.2646-.2646v-1.058z"
          />
          <path
            fill="currentColor"
            d="m.2646 5.556c-.2646 0-.2646-.2646-.2646-.2646v-1.588s0-.5292.5292-.5292h1.455c0 .5292-.5292.5292-.5292.5292h-.6615c-.2646 0-.2646.2646-.2646.2646v.7938s3.4e-7.2646.2646.2646h2.249s.2646-6.7e-6.2646.2646l-1e-7.2646z"
          />
          <path
            fill="currentColor"
            d="m9.79.344v2.831l-2.778 1.852v.2646s4e-7.2646.2646.2646h3.043v-5.556zm0 3.36v1.058s6e-7.2646-.2646.2646h-1.72z"
          />
          <path
            fill="currentColor"
            d="m11.24 3.175s-.5292 0-.5292.5292l.0069 1.323s-.0069.5294.5223.5294h2.381v-.2646c0-.2646-.2646-.2646-.2646-.2646h-1.72l1.984-1.323v-.2646s0-.2646-.2646-.2646zm1.588.5292-1.588 1.058 3.5e-5-.7938s-3.5e-5-.2646.2645-.2646z"
          />
        </symbol>
      </svg>
    );
