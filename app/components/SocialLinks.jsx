...
class SocialLinks extends Component {
  ...
  render() {
    const items = [
      {
        key: 'réseautage',
        data: <Tooltip message="réseautage">
        ...
        key: 'code is law',
        data: <Tooltip message="code is law">
        ...
        data: <Tooltip message="pretty much amazing">
          <A href="public/dorian_ratovo_portfolio_2016_screen.pdf">
            <svg width="20" height="20" viewBox="0 0 20 20">
        ...
        key: 'konnichi wa',
        data: <Tooltip message="konnichi wa">
